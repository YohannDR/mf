...
_080050A0: .4byte 0x0828FD18
	...
	thumb_func_start CallSamusUpdateGraphics
CallSamusUpdateGraphics: @ 0x080050A4
	push {r4, lr}
...
_0800C448:
	...
	thumb_func_start SamusInitializeData
SamusInitializeData: @ 0x0800C450
	push {r4, r5, r6, r7, lr}
...
InGameSubroutine: @ 0x0800DD24
	push {r4, lr}
	bl SetInGameVBlankCode
	movs r4, #0
	ldr r0, _0800DD44 @ =gSubGameMode1
	movs r1, #0
	ldrsh r0, [r0, r1]
	cmp r0, #6
	bls _0800DD38
...
_0800DD38:
	lsls r0, r0, #2
	ldr r1, _0800DD48 @ =_0800DD4C
	adds r0, r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_0800DD44: .4byte gSubGameMode1
_0800DD48: .4byte _0800DD4C
_0800DD4C: @ jump table
	.4byte _0800DD68 @ case 0
	.4byte _0800DDA0 @ case 1
	.4byte _0800DDD8 @ case 2
	.4byte _0800DE5E @ case 3
	.4byte _0800DE94 @ case 4
	.4byte _0800DE9A @ case 5
	.4byte _0800DEB0 @ case 6
_0800DD68:
	ldr r0, _0800DD94 @ =gUnk_03000be3
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r0, #0
	bne _0800DD78
	bl ResetDemoInputAndDuration
_0800DD78:
	ldr r0, _0800DD98 @ =gDemoState
	ldrb r0, [r0]
	cmp r0, #2
	bne _0800DD84
	bl CopyDemoInput
...
_0800DDAE:
	...
	cmp r0, #0
	beq _0800DDC8
	ldr r1, _0800DDC4 @ =gSubGameMode1
	movs r0, #4
	strh r0, [r1]
	b _0800DEB8
	.align 2, 0
...
_0800DDD8:
	...
	cmp r0, #0
	beq _0800DE04
	ldr r1, _0800DE38 @ =gSubGameMode1
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
	ldr r1, _0800DE3C @ =gPauseScreenFlag
	movs r0, #2
	strb r0, [r1]
_0800DE04:
	ldr r0, _0800DE38 @ =gSubGameMode1
	movs r1, #0
	ldrsh r0, [r0, r1]
	cmp r0, #2
	bne _0800DE54
	ldr r0, _0800DE40 @ =gButtonInput
	ldrh r1, [r0]
	movs r0, #0x40
	ands r0, r1
	cmp r0, #0
	...
	strb r0, [r1]
_0800DE20:
	ldr r1, _0800DE48 @ =gPreventMovementTimer
	ldrh r0, [r1]
	cmp r0, #0
	beq _0800DE4C
	subs r0, #1
...
_0800DE4C:
	...
	bl SamusUpdateCollisionData
_0800DE54:
	bl UpdateInGameTimer
	bl unk_659a0
	b _0800DEB8
_0800DE5E:
	bl IoWriteRegistersDuringTransition
	bl unk_6e4bc
	cmp r0, #0
	beq _0800DEB8
	ldr r1, _0800DE88 @ =gSubGameMode1
	movs r0, #0
	strh r0, [r1]
	ldr r0, _0800DE8C @ =gPauseScreenFlag
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r0, #0
	bne _0800DE84
	ldr r0, _0800DE90 @ =gCurrentCutscene
	ldrb r0, [r0]
	cmp r0, #0
	beq _0800DEB8
_0800DE84:
	...
	b _0800DEB8
	.align 2, 0
_0800DE88: .4byte gSubGameMode1
_0800DE8C: .4byte gPauseScreenFlag
_0800DE90: .4byte gCurrentCutscene
_0800DE94:
	bl unk_d638
	b _0800DEB8
_0800DE9A:
...
_0800DEB0:
	...
	bl unk_659a0
_0800DEB8:
	ldr r0, _0800DED8 @ =gSubGameMode1
	ldrh r1, [r0]
	subs r0, r1, #4
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
...
_0800DF34:
	bl unk_ec38
	bl ProjectileDrawAll_True
	bl ResetFreeOam
	bl UpdateRoom
	bl CallCheckPlayLowHealthSound
_0800DF48:
	adds r0, r4, #0
	pop {r4}
	pop {r1}
...
SetInGameVBlankCode: @ 0x0800DF58
	push {lr}
	ldr r0, _0800DF70 @ =gSubGameMode1
	movs r1, #0
	ldrsh r0, [r0, r1]
	cmp r0, #2
	beq _0800DF84
	...
	b _0800DF78
	.align 2, 0
_0800DF70: .4byte gSubGameMode1
_0800DF74:
	cmp r0, #3
	bne _0800DF84
_0800DF78:
	ldr r0, _0800DF80 @ =VBlankCodeDuringLoads
	bl CallbackSetVBlank
	b _0800DF8A
	.align 2, 0
_0800DF80: .4byte VBlankCodeDuringLoads
_0800DF84:
	ldr r0, _0800DF90 @ =VBlankCodeInGame
	bl CallbackSetVBlank
_0800DF8A:
	pop {r0}
	bx r0
	.align 2, 0
_0800DF90: .4byte VBlankCodeInGame

	thumb_func_start TransferSamusAndSA_XGraphics
...
_0800E118: .4byte 0x80000010
	...
	thumb_func_start VBlankCodeDuringLoads
VBlankCodeDuringLoads: @ 0x0800E11C
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	ldr r3, _0800E224 @ =0x040000D4
	ldr r0, _0800E228 @ =gOamData
	str r0, [r3]
	movs r0, #0xe0
	lsls r0, r0, #0x13
	str r0, [r3, #4]
	ldr r0, _0800E22C @ =0x84000100
	str r0, [r3, #8]
	ldr r0, [r3, #8]
	ldr r6, _0800E230 @ =0x03000068
	ldrb r1, [r6, #7]
	movs r0, #0x80
	ands r0, r1
	cmp r0, #0
	beq _0800E1BC
	ldr r2, _0800E234 @ =0x040000B0
	ldr r7, _0800E238 @ =0x02024000
	str r7, [r2]
	ldr r5, [r6]
	str r5, [r2, #4]
	ldrb r0, [r6, #6]
	lsrs r0, r0, #1
	ldr r1, _0800E23C @ =0x80600000
	orrs r0, r1
	str r0, [r2, #8]
	ldr r0, [r2, #8]
	mov r0, sp
	...
	mov r0, sp
	strb r4, [r0]
	ldr r0, _0800E240 @ =gVBlankRequestFlag
	ldrh r0, [r0]
	movs r1, #1
	ands r1, r0
	ldrb r0, [r6, #6]
...
_0800E1BC:
	...
	ldr r2, _0800E250 @ =0x03000006
	ldrh r1, [r2]
	cmp r1, #0
	beq _0800E1D2
	ldr r0, _0800E254 @ =0x04000050
	strh r1, [r0]
	movs r0, #0
	strh r0, [r2]
_0800E1D2:
	...
	bx r0
	.align 2, 0
_0800E224: .4byte 0x040000D4
_0800E228: .4byte gOamData
_0800E22C: .4byte 0x84000100
_0800E230: .4byte 0x03000068
_0800E234: .4byte 0x040000B0
_0800E238: .4byte 0x02024000
_0800E23C: .4byte 0x80600000
_0800E240: .4byte gVBlankRequestFlag
_0800E244: .4byte 0x02024A00
_0800E248: .4byte 0x0300000E
_0800E24C: .4byte 0xA2600000
...
unk_e26c: @ 0x0800E26C
	push {lr}
	ldr r1, _0800E2CC @ =0x040000D4
	ldr r0, _0800E2D0 @ =gOamData
	str r0, [r1]
	movs r0, #0xe0
	lsls r0, r0, #0x13
	str r0, [r1, #4]
	ldr r0, _0800E2D4 @ =0x84000100
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	movs r0, #0
	bl TransferSamusAndSA_XGraphics
...
VBlankCodeInGame: @ 0x0800E2E8
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	ldr r3, _0800E3D8 @ =0x040000D4
	ldr r0, _0800E3DC @ =gOamData
	str r0, [r3]
	movs r0, #0xe0
	lsls r0, r0, #0x13
	str r0, [r3, #4]
	ldr r0, _0800E3E0 @ =0x84000100
	str r0, [r3, #8]
	ldr r0, [r3, #8]
	ldr r6, _0800E3E4 @ =0x03000068
	ldrb r1, [r6, #7]
	movs r0, #0x80
	ands r0, r1
	cmp r0, #0
	beq _0800E388
	ldr r2, _0800E3E8 @ =0x040000B0
	ldr r7, _0800E3EC @ =0x02024000
	str r7, [r2]
	ldr r5, [r6]
	str r5, [r2, #4]
	ldrb r0, [r6, #6]
	lsrs r0, r0, #1
	ldr r1, _0800E3F0 @ =0x80600000
	orrs r0, r1
	str r0, [r2, #8]
	ldr r0, [r2, #8]
	mov r0, sp
	...
	mov r0, sp
	strb r4, [r0]
	ldr r0, _0800E3F4 @ =gVBlankRequestFlag
	ldrh r0, [r0]
	movs r1, #1
	ands r1, r0
	ldrb r0, [r6, #6]
...
_0800E388:
	...
	bx r0
	.align 2, 0
_0800E3D8: .4byte 0x040000D4
_0800E3DC: .4byte gOamData
_0800E3E0: .4byte 0x84000100
_0800E3E4: .4byte 0x03000068
_0800E3E8: .4byte 0x040000B0
_0800E3EC: .4byte 0x02024000
_0800E3F0: .4byte 0x80600000
_0800E3F4: .4byte gVBlankRequestFlag
_0800E3F8: .4byte 0x02024A00
...
unk_e414: @ 0x0800E414
	...
	thumb_func_start InitAndLoadGenerics
InitAndLoadGenerics: @ 0x0800E420
	push {r4, r5, r6, lr}
	sub sp, #4
	ldr r3, _0800E490 @ =0x04000208
	movs r0, #0
	strh r0, [r3]
	ldr r2, _0800E494 @ =0x04000004
	ldrh r1, [r2]
	ldr r0, _0800E498 @ =0x0000FFEF
	ands r0, r1
	strh r0, [r2]
	ldr r2, _0800E49C @ =0x04000200
	ldrh r1, [r2]
	ldr r0, _0800E4A0 @ =0x0000FFFD
	ands r0, r1
	strh r0, [r2]
	movs r0, #1
	strh r0, [r3]
	ldr r0, _0800E4A4 @ =unk_e414
	bl CallbackSetVBlank
	ldr r4, _0800E4A8 @ =gUnk_03000be3
	movs r0, #0
	ldrsb r0, [r4, r0]
	cmp r0, #0
	bne _0800E45A
...
_0800E45A:
	...
	cmp r0, #0
	beq _0800E47E
	ldr r0, _0800E4B4 @ =gCurrentCutscene
	ldrb r0, [r0]
	cmp r0, #0
	beq _0800E4BC
_0800E47E:
	ldr r1, _0800E4B8 @ =0x04000050
	movs r0, #0xff
	strh r0, [r1]
	adds r1, #4
	ldrh r0, [r5]
	...
	b _0800E4D6
	.align 2, 0
_0800E490: .4byte 0x04000208
_0800E494: .4byte 0x04000004
_0800E498: .4byte 0x0000FFEF
_0800E49C: .4byte 0x04000200
...
_0800E4BC:
	ldr r1, _0800E61C @ =0x04000050
	movs r0, #0xe7
	strh r0, [r1]
	ldr r0, _0800E620 @ =0x04000054
	strh r3, [r0]
	subs r1, #0x42
	ldr r2, _0800E624 @ =0x00004604
	adds r0, r2, #0
	strh r0, [r1]
	subs r1, #0xe
	movs r2, #0xc0
...
_0800E4D6:
	...
	cmp r0, #0
	bne _0800E4E8
	ldr r0, _0800E628 @ =gCurrentCutscene
	ldrb r0, [r0]
	cmp r0, #0
	beq _0800E4FA
_0800E4E8:
	ldr r1, _0800E62C @ =0x0201C000
	ldr r2, _0800E630 @ =0x06010000
	movs r3, #0x80
	lsls r3, r3, #7
	movs r0, #0x10
	str r0, [sp]
	...
	bl DmaTransfer
_0800E4FA:
	ldr r1, _0800E634 @ =gDebugFlag
	movs r0, #0
	strb r0, [r1]
	ldr r1, _0800E638 @ =0x040000D4
	ldr r0, _0800E63C @ =0x083E40DC
	str r0, [r1]
	ldr r0, _0800E640 @ =0x05000240
	str r0, [r1, #4]
	ldr r0, _0800E644 @ =0x80000060
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	bl SamusInitializeData
...
_0800E528:
	...
	cmp r0, #0x8b
	bls _0800E528
	ldr r0, _0800E64C @ =gPauseScreenFlag
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r0, #0
	bne _0800E554
	ldr r0, _0800E650 @ =gUnk_03000be3
	ldrb r0, [r0]
	lsls r0, r0, #0x18
	asrs r0, r0, #0x18
	cmp r0, #0
...
_0800E578:
	...
	cmp r0, #0x8b
	bls _0800E578
	bl CheckResetHudAndParticles
	bl SpriteLoadAllData
	bl ProjectileCallLoadGraphicsAndClearProjectiles
	ldr r6, _0800E64C @ =gPauseScreenFlag
	movs r0, #0
	ldrsb r0, [r6, r0]
	cmp r0, #0
	beq _0800E5BC
	ldr r1, _0800E660 @ =0x02020000
	ldr r2, _0800E664 @ =0x06014000
	movs r3, #0x80
	lsls r3, r3, #7
	movs r0, #0x10
	str r0, [sp]
	...
	bl DmaTransfer
	ldr r1, _0800E638 @ =0x040000D4
	ldr r0, _0800E668 @ =0x02035700
	str r0, [r1]
	ldr r0, _0800E66C @ =0x05000300
	str r0, [r1, #4]
	ldr r0, _0800E670 @ =0x80000080
	str r0, [r1, #8]
	ldr r0, [r1, #8]
_0800E5BC:
	bl SetupCurrentEventBasedEffect
	bl unk_6dd30
	bl CheckUpdateMusicDuringRoomLoad
	ldr r5, _0800E650 @ =gUnk_03000be3
	movs r4, #0
	ldrsb r4, [r5, r4]
	cmp r4, #0
	bne _0800E5DE
...
_0800E5DE:
	...
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	ldr r4, _0800E628 @ =gCurrentCutscene
	ldr r2, _0800E67C @ =gIsLoadingFile
	ldr r3, _0800E680 @ =VBlankCodeDuringLoads
	cmp r0, #0x8b
	bhi _0800E604
_0800E5F8:
	ldrh r0, [r1]
...
_0800E604:
	...
	bx r0
	.align 2, 0
_0800E61C: .4byte 0x04000050
_0800E620: .4byte 0x04000054
_0800E624: .4byte 0x00004604
_0800E628: .4byte gCurrentCutscene
_0800E62C: .4byte 0x0201C000
_0800E630: .4byte 0x06010000
_0800E634: .4byte gDebugFlag
_0800E638: .4byte 0x040000D4
_0800E63C: .4byte 0x083E40DC
_0800E640: .4byte 0x05000240
_0800E644: .4byte 0x80000060
...
_0800E680: .4byte VBlankCodeDuringLoads
	...
	thumb_func_start unk_e684
unk_e684: @ 0x0800E684
	push {r4, r5, r6, r7, lr}
	movs r5, #0
	movs r7, #0
	ldr r1, _0800E740 @ =gPreviousXPosition
...
_0800E6D2:
	...
	cmp r0, #0
	beq _0800E6DC
	ldr r5, _0800E75C @ =0x0000FFF4
_0800E6DC:
	movs r0, #0x40
	ands r0, r1
	cmp r0, #0
	beq _0800E6E6
	ldr r7, _0800E75C @ =0x0000FFF4
_0800E6E6:
	movs r0, #0x80
	ands r0, r1
	cmp r0, #0
