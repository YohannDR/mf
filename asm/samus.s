...
_08004D8A:
	...
	adds r0, #1
	strb r1, [r0]
	ldr r0, _08004DC4 @ =gSamusAnimationInfo
	strb r1, [r0]
	strb r1, [r0, #1]
	strb r1, [r0, #2]
	strb r1, [r0, #3]
...
_08004DC4: .4byte gSamusAnimationInfo
...
_08004EA6:
	...
	ands r0, r1
	adds r4, r2, #0
	ldr r3, _08004EBC @ =gSamusPhysics
	cmp r0, #0
	bne _08004ED2
	b _08004ED0
	.align 2, 0
_08004EB8: .4byte gEquipment
_08004EBC: .4byte gSamusPhysics
_08004EC0:
	ldr r2, _08004F04 @ =gSamusPhysics
	ldrb r1, [r2]
	movs r0, #0x80
	ands r0, r1
...
SamusBombBounce: @ 0x08005138
	...
	lsls r0, r0, #0x18
	lsrs r3, r0, #0x18
	ldr r0, _08005168 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	bne _080051A6
	movs r2, #0
...
_0800534C:
	...
	adds r0, #1
	strb r0, [r1, #6]
	ldr r0, _08005378 @ =gSamusPhysics
	ldrb r0, [r0]
	adds r4, r2, #0
	cmp r0, #1
	bne _080053FE
...
_0800618C:
	...
	b _0800623C
_08006196:
	ldr r0, _080061B8 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	bne _0800623C
...
_080061DC:
	...
	cmp r0, #0
	beq _080061EC
	ldr r0, _080061F8 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _0800623C
_080061EC:
	...
	b _0800623C
	.align 2, 0
_080061F8: .4byte gSamusPhysics
_080061FC:
	ldr r0, _08006210 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _08006214
	movs r0, #0
...
_08006412:
	...
	strb r0, [r1, #0xb]
_0800641C:
	ldr r4, _08006480 @ =gSamusAnimationInfo
	ldrb r0, [r4, #4]
	cmp r0, #0
	beq _08006438
	movs r1, #0xf
...
SamusStanding: @ 0x08006590
	...
	cmp r0, #0
	beq _080065D8
	ldr r0, _080065CC @ =gSamusAnimationInfo
	ldrb r0, [r0, #4]
	cmp r0, #0
	beq _080065D8
...
_080065CC: .4byte gSamusAnimationInfo
...
_08006618:
	...
	bne _080066B0
_08006646:
	ldr r0, _0800665C @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _08006660
	movs r0, #0x95
...
SamusTurningAround: @ 0x08006734
	...
	cmp r0, #0
	beq _0800677C
	ldr r0, _08006770 @ =gSamusAnimationInfo
	ldrb r0, [r0, #4]
	cmp r0, #0
	beq _0800677C
...
_08006770: .4byte gSamusAnimationInfo
...
_08006796:
	movs r0, #8
	strb r0, [r1, #1]
	ldr r0, _080067B4 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _080067B8
	movs r0, #0x95
...
SamusRunning: @ 0x08006880
	...
	cmp r0, #0
	beq _080068BC
	ldr r0, _080068B4 @ =gSamusPhysics
	ldrb r0, [r0]
...
_080068B4: .4byte gSamusPhysics
_080068B8: .4byte gSamusData
_080068BC:
	ldr r2, _080068E0 @ =gSamusPhysics
	ldrh r4, [r2, #0xe]
...
_08006926:
	...
	cmp r0, #0
	beq _08006958
	ldr r0, _08006954 @ =gSamusPhysics
	movs r1, #0xc
	ldrsh r0, [r0, r1]
	lsls r1, r4, #0x10
	asrs r1, r1, #0x10
...
SamusRunningGFX: @ 0x08006988
	...
	lsrs r1, r0, #0x18
_080069A8:
	ldr r0, _080069E4 @ =gSamusPhysics
	ldrb r2, [r0]
	cmp r2, #0
	beq _080069B4
	lsls r0, r1, #0x19
...
_08006A88:
	...
	cmp r0, #0
	beq _08006ACC
	ldr r0, _08006AA0 @ =gSamusAnimationInfo
	ldrb r0, [r0, #4]
	cmp r0, #0
	beq _08006AA4
	movs r0, #0x23
	b _08006B64
	.align 2, 0
_08006AA0: .4byte gSamusAnimationInfo
_08006AA4:
...
_08006ACC:
	movs r6, #0
	ldr r5, _08006AF4 @ =gSamusPhysics
	ldrh r2, [r5, #6]
	adds r7, r2, #0
...
SamusTurningAroundMidAir: @ 0x08006BE4
	...
	cmp r0, #0
	beq _08006C3C
	ldr r0, _08006C04 @ =gSamusAnimationInfo
	ldrb r0, [r0, #4]
	cmp r0, #0
	beq _08006C08
	movs r0, #0x23
...
_08006C04: .4byte gSamusAnimationInfo
_08006C08:
...
SamusCrouching: @ 0x08006D2C
	...
	cmp r0, #0
	beq _08006D74
	ldr r0, _08006D68 @ =gSamusAnimationInfo
	ldrb r0, [r0, #4]
	cmp r0, #0
	beq _08006D74
...
_08006D68: .4byte gSamusAnimationInfo
...
SamusTurningAroundAndCrouching: @ 0x08006F6C
	...
	cmp r0, #0
	beq _08006FB4
	ldr r0, _08006FA8 @ =gSamusAnimationInfo
	ldrb r0, [r0, #4]
	cmp r0, #0
	beq _08006FB4
...
_08006FA8: .4byte gSamusAnimationInfo
...
_080071F8:
	bl SamusAimCannonMidAir
	ldr r1, _08007240 @ =gSamusPhysics
	ldrh r4, [r1, #6]
...
_08007338:
	lsls r0, r4, #0x10
	asrs r0, r0, #0x10
	ldr r1, _0800736C @ =gSamusPhysics
	movs r2, #8
	ldrsh r1, [r1, r2]
	bl SamusApplyXAcceleration
_08007346:
...
SamusSpinningGFX: @ 0x08007378
	...
	adds r0, r0, r4
	ldrb r3, [r0, #0xc]
	ldr r0, _080073E4 @ =gSamusPhysics
	ldrb r1, [r0]
	adds r5, r0, #0
	cmp r1, #0
	beq _0800739A
...
_08007524:
	...
	bne _0800754E
_08007528:
	ldr r0, _08007540 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _08007544
	movs r0, #0x95
...
_080075D0:
	...
	cmp r0, #0
	beq _08007612
	ldr r0, _08007604 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _08007608
	movs r0, #0x95
...
_08007612:
	...
	cmp r0, #0
	beq _08007640
	ldr r1, _0800763C @ =gSamusPhysics
	movs r2, #0xc
	ldrsh r0, [r1, r2]
	movs r2, #0xe
	ldrsh r1, [r1, r2]
...
SamusMorphBallMidAir: @ 0x080076D8
	...
	cmp r0, #0
	bne _0800771E
	ldr r0, _08007710 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _08007714
	movs r0, #0x95
...
_08007764:
	...
	beq _0800778C
_08007774:
	ldr r1, _08007788 @ =gSamusPhysics
	movs r2, #6
	ldrsh r0, [r1, r2]
	movs r2, #0xa
	ldrsh r1, [r1, r2]
...
SamusWallJumping: @ 0x08007888
	...
	cmp r0, #0
	beq _080078BC
	ldr r3, _080078B8 @ =gSamusPhysics
	movs r0, #0x1a
	ldrsh r1, [r2, r0]
	movs r2, #8
	ldrsh r0, [r3, r2]
...
_080078B8: .4byte gSamusPhysics
_080078BC:
	movs r3, #0x1a
	ldrsh r0, [r2, r3]
	ldr r2, _080078E8 @ =gSamusPhysics
	movs r3, #8
	ldrsh r1, [r2, r3]
	cmn r0, r1
	ble _080078D2
...
_08007918:
	bl SamusAimCannonMidAir
	ldr r0, _08007944 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _0800792A
...
SamusUsingAnElevatorGFX: @ 0x08007A2C
	push {r4, lr}
	ldr r2, _08007A9C @ =gSamusAnimationInfo
	ldrb r0, [r2, #1]
	adds r0, #1
	strb r0, [r2, #1]
...
SamusHangingOnLedgeGFX: @ 0x08007C14
	...
	adds r0, r0, r4
	ldrb r1, [r0, #0xc]
	ldr r0, _08007C64 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _08007C32
	lsls r0, r1, #0x19
...
SamusSpaceJumpingGFX: @ 0x08007E74
	...
	adds r0, r0, r1
	ldrb r4, [r0, #0xc]
	ldr r0, _08007EC0 @ =gSamusPhysics
	ldrb r3, [r0]
	cmp r3, #0
	beq _08007E92
	lsls r0, r4, #0x19
...
_08007E92:
	...
	cmp r0, r1
	bne _08007EDC
	ldr r0, _08007EC8 @ =gSamusAnimationInfo
	ldrb r1, [r0, #3]
	movs r0, #1
	ands r0, r1
	cmp r0, #0
...
_08007EC8: .4byte gSamusAnimationInfo
_08007ECC:
	movs r0, #0x6f
	bl SoundPlay
_08007ED2:
	ldr r1, _08007F0C @ =gSamusAnimationInfo
	ldrb r0, [r1, #3]
	adds r0, #1
	strb r0, [r1, #3]
...
SamusScrewAttackingGFX: @ 0x08007F18
	...
	adds r0, r0, r7
	ldrb r4, [r0, #0xc]
	ldr r0, _08007FBC @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _08007F36
	lsls r0, r4, #0x19
...
_08007F4A:
	...
	strb r0, [r6]
_08007F6C:
	ldr r1, _08007FC4 @ =gSamusAnimationInfo
	ldrb r0, [r1, #1]
	adds r2, r0, #1
	strb r2, [r1, #1]
...
_08007FC4: .4byte gSamusAnimationInfo
...
_08008008:
	...
	cmp r0, #0x80
	bne _08008020
	ldr r1, _0800801C @ =gSamusAnimationInfo
	movs r0, #0xb4
	strb r0, [r1, #4]
	movs r0, #7
	b _08008046
	.align 2, 0
_0800801C: .4byte gSamusAnimationInfo
_08008020:
	movs r0, #0x10
	ands r0, r3
	cmp r0, #0
...
SamusDelayBeforeShinesparkingGFX: @ 0x080080DC
	push {r4, r5, lr}
	ldr r1, _08008130 @ =gSamusAnimationInfo
	movs r0, #2
	strb r0, [r1, #4]
...
_080082EA:
	...
	mov r1, r8
	strb r1, [r0]
	ldr r0, _0800833C @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _08008340
	movs r0, #0x95
...
_08008390:
	...
	mov r1, r8
	strb r1, [r0]
	ldr r0, _080083C0 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _080083C4
	movs r0, #0x95
...
_080083D2:
	strh r1, [r0, #0x1c]
_080083D4:
	ldr r0, _080083FC @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _080083E6
...
SamusHangingFromVerticalLadderGFX: @ 0x08008400
	...
	adds r0, r0, r5
	ldrb r1, [r0, #0xc]
	ldr r0, _0800845C @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _08008426
	lsls r0, r1, #0x19
...
SamusStartingToHoldYourArmCannonOutOnAVerticalLadderGFX: @ 0x080084B0
	...
	adds r0, r0, r4
	ldrb r1, [r0, #0xc]
	ldr r0, _080084F8 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _080084CE
	lsls r0, r1, #0x19
...
SamusShootingOnVerticalLadderGFX: @ 0x0800858C
	...
	adds r0, r0, r4
	ldrb r1, [r0, #0xc]
	ldr r0, _080085D4 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _080085AA
	lsls r0, r1, #0x19
...
SamusStartingToPutAwayYourArmCannonOnVerticalLadderGFX: @ 0x08008618
	...
	adds r0, r0, r4
	ldrb r1, [r0, #0xc]
	ldr r0, _08008670 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _08008636
	lsls r0, r1, #0x19
...
_0800878C:
	...
	strb r0, [r1]
_08008796:
	ldr r0, _080087B0 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _080087A6
	lsls r0, r5, #0x10
...
SamusMovingOnHorizontalLadderGFX: @ 0x080087B4
	...
	adds r0, r0, r5
	ldrb r1, [r0, #0xc]
	ldr r0, _080087FC @ =gSamusPhysics
	ldrb r2, [r0]
	cmp r2, #0
	beq _080087D2
	lsls r0, r1, #0x19
...
SamusTurningAroundOnHorizontalLadderGFX: @ 0x08008864
	...
	adds r0, r0, r4
	ldrb r1, [r0, #0xc]
	ldr r0, _080088BC @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _08008882
	lsls r0, r1, #0x19
...
SamusShootingOnHorizontalLadderGFX: @ 0x0800894C
	...
	adds r0, r0, r4
	ldrb r1, [r0, #0xc]
	ldr r0, _08008994 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	beq _0800896A
	lsls r0, r1, #0x19
...
SamusUnlockingSecurityGFX: @ 0x080089E0
	...
	strb r0, [r2]
_08008A14:
	ldr r2, _08008A58 @ =gSamusAnimationInfo
	ldrb r0, [r2, #1]
	adds r0, #1
	strb r0, [r2, #1]
...
SamusLoadingSave: @ 0x08008C78
	push {lr}
	ldr r1, _08008C8C @ =gSamusAnimationInfo
	ldrb r0, [r1]
	cmp r0, #0
	bne _08008C86
	adds r0, #1
...
_08008C86:
	...
	bx r1
	.align 2, 0
_08008C8C: .4byte gSamusAnimationInfo
...
_08008CD8:
	...
	b _08008D36
	.align 2, 0
_08008D1C: .4byte gSamusAnimationInfo
...
_08008D6A:
	...
	movs r1, #0x40
	strb r1, [r0, #5]
	ldr r1, _08008DA4 @ =gSamusAnimationInfo
	ldrb r2, [r1]
	adds r1, r0, #0
	cmp r2, #0
	bne _08008DE2
...
_08008DA4: .4byte gSamusAnimationInfo
...
SamusDyingGFX: @ 0x08008DEC
	push {r4, r5, lr}
	ldr r0, _08008E68 @ =gSamusAnimationInfo
	ldrb r1, [r0]
	adds r3, r0, #0
	cmp r1, #1
	bls _08008E2A
...
_080092BC:
	movs r0, #0x16
	strb r0, [r2, #1]
	ldr r0, _080092D4 @ =gSamusPhysics
	ldrb r1, [r0]
	adds r4, r0, #0
	cmp r1, #0
	beq _080092D0
...
_080093A8:
	...
	cmp r0, #0xaa
	bne _080093D8
	ldr r0, _080093D4 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	beq _08009404
	movs r0, #0x71
...
_080093D4: .4byte gSamusPhysics
_080093D8:
	cmp r0, #0xdc
	bne _0800941A
	ldr r0, _080093EC @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	beq _08009404
	movs r0, #0x72
...
_080093F0:
	...
	cmp r0, #1
	bne _0800941A
	ldr r0, _08009410 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _08009414
_08009404:
...
_08009600:
	...
	cmp r1, r0
	bge _08009640
	ldr r0, _08009638 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #0
	bne _08009640
...
_080098AC:
	...
	movs r0, #0x30
	strb r0, [r1, #5]
	ldr r0, _080098DC @ =gSamusAnimationInfo
	strb r2, [r0, #4]
	pop {r0}
	bx r0
	.align 2, 0
...
_080098DC: .4byte gSamusAnimationInfo
...
_08009CF8:
	...
	strh r0, [r3, #0x1c]
_08009CFC:
	ldr r1, _08009D04 @ =gSamusAnimationInfo
	movs r0, #0
	strb r0, [r1, #4]
	b _08009D70
	.align 2, 0
_08009D04: .4byte gSamusAnimationInfo
_08009D08:
...
_08009D1C:
	ldr r0, _08009D2C @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _08009D30
	movs r0, #0x96
...
_08009E90:
	ldr r0, _08009EA4 @ =gSamusPhysics
	ldrh r1, [r3, #0x1c]
	ldrh r2, [r0, #4]
	lsls r4, r1, #0x10
	lsls r2, r2, #0x10
...
_0800A228:
	...
	movs r0, #0x18
	mov sb, r0
	ldr r0, _0800A248 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _0800A24C
	movs r0, #0x97
...
_0800A25A:
	...
	movs r2, #0x26
	mov sb, r2
	ldr r0, _0800A290 @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _0800A294
	movs r0, #0x97
...
_0800A328:
	...
	movs r2, #0x2b
	mov sb, r2
	ldr r0, _0800A37C @ =gSamusPhysics
	ldrb r0, [r0]
	cmp r0, #1
	bne _0800A380
	movs r0, #0x97
...
_0800B98C:
	ldr r0, _0800B9A8 @ =gSamusAnimationInfo
	ldrb r0, [r0, #2]
	lsls r0, r0, #3
	...
	b _0800BCD8
	.align 2, 0
_0800B9A8: .4byte gSamusAnimationInfo
...
_0800BA38:
	ldr r2, _0800BA78 @ =gSamusAnimationInfo
	ldrb r0, [r2]
	cmp r0, #1
	beq _0800BA42
	b _0800BCE0
...
_0800BA88:
	...
	b _0800BCE0
	.align 2, 0
_0800BAB0: .4byte gSamusAnimationInfo
...
_0800BD2C: .4byte gSamusAnimationInfo
...
_0800BFC0:
	...
	cmp r0, #0
	bne _0800BFD6
	ldr r0, _0800BFEC @ =gSamusAnimationInfo
	ldrb r0, [r0, #4]
	cmp r0, #0
	beq _0800BFFC
_0800BFD6:
...
_0800BFEC: .4byte gSamusAnimationInfo
...
_0800C4AC:
	...
	strb r2, [r0]
	ldr r1, _0800C578 @ =gSamusPhysics
	adds r0, r3, #0
	ldm r0!, {r5, r6, r7}
	stm r1!, {r5, r6, r7}
	ldr r0, [r0]
...
_0800C4D6:
	...
	movs r2, #0x3c
	bl memcpy
	ldr r1, _0800C590 @ =gSamusAnimationInfo
	adds r0, r4, #0
	ldm r0!, {r5, r6, r7}
	stm r1!, {r5, r6, r7}
	ldr r2, _0800C55C @ =gSamusEnvironmentalEffects
...
_0800C590: .4byte gSamusAnimationInfo
