...
extern const struct FrameData sCoreXLightningOam_0[5];
extern const struct FrameData sCoreXLightningOam_1[5];
extern const struct FrameData sCoreXLightningOam_2[5];
extern const struct FrameData sCoreXLightningOam_Unused[19];
