...
const u8 sTitleScreenLogoGfx[] = INCBIN_U8("data/menus/title_screen/logo.gfx.lz");
ALIGN2;
const u8 sTitleScreenLogoTileTable[] = INCBIN_U8("data/menus/title_screen/logo.tt.lz");
ALIGN2;
const u8 sTitleScreen_596884[] = INCBIN_U8("data/menus/title_screen/596884.tt.lz");
ALIGN2;
