...
const u8 sTileset_43_Gfx[] = INCBIN_U8("data/tilesets/43.gfx.lz"); ALIGN2();

const u8 sTileset_52_Gfx[] = INCBIN_U8("data/tilesets/52.gfx.lz"); ALIGN2();

const u8 sTileset_81_Gfx[] = INCBIN_U8("data/tilesets/81.gfx.lz"); ALIGN2();

const u8 sTileset_86_Gfx[] = INCBIN_U8("data/tilesets/86.gfx.lz"); ALIGN2();

const u8 sTileset_90_Gfx[] = INCBIN_U8("data/tilesets/90.gfx.lz"); ALIGN2();

const u8 sTileset_81_Bg_Gfx[] = INCBIN_U8("data/tilesets/81_Bg.gfx.lz"); ALIGN2();

const u8 sTileset_52_Bg_Gfx[] = INCBIN_U8("data/tilesets/52_Bg.gfx.lz"); ALIGN2();

const u8 sTileset_90_Bg_Gfx[] = INCBIN_U8("data/tilesets/90_Bg.gfx.lz"); ALIGN2();

const u8 sTileset_43_Bg_Gfx[] = INCBIN_U8("data/tilesets/43_Bg.gfx.lz"); ALIGN2();
...
const u8 sSector4_3_SpriteData0[ROOM_SPRITE_DATA_COUNT(8)] = {
    ...
    10, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    12, 19, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(10),
    16, 20, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(10),
    18, 17, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(10),
    20, 17, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_5_SpriteData1[ROOM_SPRITE_DATA_COUNT(4)] = {
    2, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(7),
    4, 8, ROOM_SPRITESET_IDX(PSPRITE_TARGET_SIDEWAYS),
    4, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
...
const u8 sSector4_5_SpriteData0[ROOM_SPRITE_DATA_COUNT(3)] = {
    4, 8, ROOM_SPRITESET_IDX(PSPRITE_TARGET_SIDEWAYS),
    4, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    8, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_6_SpriteData1[ROOM_SPRITE_DATA_COUNT(11)] = {
    3, 29, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    ...
    19, 23, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    21, 7, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    23, 19, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(3),
    24, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    24, 35, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    24, 39, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    26, 30, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector4_6_SpriteData0[ROOM_SPRITE_DATA_COUNT(15)] = {
    3, 23, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    3, 29, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    5, 25, ROOM_SPRITESET_IDX(PSPRITE_TARGET_SIDEWAYS),
    6, 44, SSP_X_UNABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(3),
    ...
    20, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    20, 26, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    20, 42, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    21, 7, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    24, 39, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    26, 30, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    32, 21, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_7_SpriteData0[ROOM_SPRITE_DATA_COUNT(13)] = {
    ...
    16, 30, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
...
const u8 sSector4_12_SpriteData0[ROOM_SPRITE_DATA_COUNT(10)] = {
    ...
    11, 27, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    11, 38, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    11, 52, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_13_SpriteData0[ROOM_SPRITE_DATA_COUNT(13)] = {
    ...
    8, 41, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    12, 43, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    17, 20, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    17, 28, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    ...
    24, 15, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    26, 26, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    26, 40, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
...
const u8 sSector4_14_SpriteData0[ROOM_SPRITE_DATA_COUNT(18)] = {
    ...
    14, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ...
    23, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    26, 8, ROOM_SPRITESET_IDX(PSPRITE_TARGET_DIAGONAL),
    26, 13, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(2),
    30, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    32, 11, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(2),
    35, 12, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(2),
    37, 6, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    41, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
...
const u8 sSector4_15_SpriteData0[ROOM_SPRITE_DATA_COUNT(13)] = {
    ...
    4, 41, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    4, 45, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(0),
    5, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    6, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    6, 29, ROOM_SPRITESET_IDX(PSPRITE_TARGET_SIDEWAYS),
    8, 37, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
...
const u8 sSector4_16_SpriteData0[ROOM_SPRITE_DATA_COUNT(11)] = {
    ...
    13, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    16, 5, ROOM_SPRITESET_IDX(PSPRITE_TARGET_DIAGONAL),
    17, 6, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(0),
    18, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    20, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    22, 8, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
...
const u8 sSector4_20_SpriteData1[ROOM_SPRITE_DATA_COUNT(13)] = {
    12, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    12, 25, ROOM_SPRITESET_IDX(PSPRITE_TARGET_SIDEWAYS),
    12, 50, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    13, 34, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    13, 44, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    16, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    16, 41, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    18, 36, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    18, 46, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    18, 52, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
...
const u8 sSector4_20_SpriteData0[ROOM_SPRITE_DATA_COUNT(11)] = {
    ...
    10, 22, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    10, 38, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    10, 54, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    12, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    12, 25, ROOM_SPRITESET_IDX(PSPRITE_TARGET_SIDEWAYS),
    12, 50, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    16, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    22, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_21_SpriteData1[ROOM_SPRITE_DATA_COUNT(11)] = {
    ...
    42, 13, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    44, 8, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    46, 14, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(4),
    47, 4, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    48, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
...
const u8 sSector4_21_SpriteData0[ROOM_SPRITE_DATA_COUNT(11)] = {
    ...
    22, 10, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(4),
    31, 14, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(4),
    40, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    42, 13, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    46, 14, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(4),
    47, 4, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    54, 3, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(4),
    61, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_25_SpriteData0[ROOM_SPRITE_DATA_COUNT(8)] = {
    ...
    35, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_28_SpriteData0[ROOM_SPRITE_DATA_COUNT(10)] = {
    3, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    3, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    3, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    3, 19, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    3, 23, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    8, 7, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    8, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    8, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    8, 21, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    8, 27, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector4_31_SpriteData0[ROOM_SPRITE_DATA_COUNT(3)] = {
    9, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    10, 17, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    10, 21, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector4_33_SpriteData1[ROOM_SPRITE_DATA_COUNT(4)] = {
    8, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    12, 43, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    17, 15, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    17, 43, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector4_33_SpriteData0[ROOM_SPRITE_DATA_COUNT(8)] = {
    8, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    10, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    10, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    10, 41, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    12, 43, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    17, 15, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    17, 43, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    23, 19, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_34_SpriteData0[ROOM_SPRITE_DATA_COUNT(17)] = {
    ...
    5, 26, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ...
    11, 13, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    18, 11, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(1),
    19, 7, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(1),
    21, 6, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    21, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    29, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    29, 13, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(1),
    31, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
...
const u8 sSector4_36_SpriteData2[ROOM_SPRITE_DATA_COUNT(8)] = {
    ...
    4, 4, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    4, 28, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    6, 14, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
...
const u8 sSector4_36_SpriteData1[ROOM_SPRITE_DATA_COUNT(13)] = {
    3, 8, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(11),
    3, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(11),
    3, 18, ROOM_SPRITESET_IDX(PSPRITE_TARGET_SIDEWAYS),
    3, 24, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(11),
    4, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    4, 28, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    6, 14, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    6, 22, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(11),
    7, 20, SSP_HIDDEN_ON_ROOM_LOAD | SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(7),
    8, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(11),
    8, 17, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(11),
    12, 13, SSP_X_UNABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(8),
    13, 16, SSP_X_UNABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(8),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector4_36_SpriteData0[ROOM_SPRITE_DATA_COUNT(11)] = {
    1, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    1, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    3, 18, ROOM_SPRITESET_IDX(PSPRITE_TARGET_SIDEWAYS),
    4, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    4, 28, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(6),
    6, 14, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    7, 20, SSP_HIDDEN_ON_ROOM_LOAD | SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(7),
    12, 13, SSP_X_UNABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(8),
    13, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    13, 16, SSP_X_UNABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(8),
    13, 23, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(10),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector4_38_SpriteData1[ROOM_SPRITE_DATA_COUNT(11)] = {
    ...
    4, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    4, 27, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    8, 36, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    ...
    9, 24, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
...
const u8 sSector4_38_SpriteData0[ROOM_SPRITE_DATA_COUNT(13)] = {
    ...
    9, 19, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    9, 24, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    9, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    9, 27, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    10, 15, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(1),
...
const u8 sSector4_40_SpriteData0[ROOM_SPRITE_DATA_COUNT(10)] = {
    ...
    11, 13, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    13, 14, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    ...
    21, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(7),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector4_42_SpriteData0[ROOM_SPRITE_DATA_COUNT(3)] = {
    ...
    20, 43, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector1_38_Bg0[] = {
    2, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector1_38_Bg0.tt.lz")
};
ALIGN2();

const u8 sSector4_3_Bg0[] = {
    2, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector4_3_Bg0.tt.lz")
};
ALIGN2();

const u8 sSector4_42_Bg3[] = {
    2, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector4_42_Bg3.tt.lz")
};
ALIGN2();

const u8 sSector4_12_Bg3[] = {
    1, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector4_12_Bg3.tt.lz")
};
ALIGN2();

const u8 sSector4_31_Bg3[] = {
    1, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector4_31_Bg3.tt.lz")
};
ALIGN2();

const u8 sSector4_6_Bg3[] = {
    1, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector4_6_Bg3.tt.lz")
};
ALIGN2();
