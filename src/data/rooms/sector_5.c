...
const u8 sTileset_48_Gfx[] = INCBIN_U8("data/tilesets/48.gfx.lz"); ALIGN2();

const u8 sTileset_49_Gfx[] = INCBIN_U8("data/tilesets/49.gfx.lz"); ALIGN2();

const u8 sTileset_57_Gfx[] = INCBIN_U8("data/tilesets/57.gfx.lz"); ALIGN2();

const u8 sTileset_48_Bg_Gfx[] = INCBIN_U8("data/tilesets/48_Bg.gfx.lz"); ALIGN2();

const u8 sTileset_49_Bg_Gfx[] = INCBIN_U8("data/tilesets/49_Bg.gfx.lz"); ALIGN2();

const u8 sTileset_57_Bg_Gfx[] = INCBIN_U8("data/tilesets/57_Bg.gfx.lz"); ALIGN2();
...
const u8 sSector5_7_SpriteData0[ROOM_SPRITE_DATA_COUNT(16)] = {
    5, 15, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ...
    18, 19, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    28, 23, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    28, 28, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(2),
    33, 36, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ...
    38, 19, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    43, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
...
const u8 sSector5_8_SpriteData2[ROOM_SPRITE_DATA_COUNT(6)] = {
    ...
    8, 7, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
...
const u8 sSector5_9_SpriteData1[ROOM_SPRITE_DATA_COUNT(19)] = {
    ...
    4, 8, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ...
    21, 14, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ...
    35, 13, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
...
const u8 sSector5_13_SpriteData0[ROOM_SPRITE_DATA_COUNT(7)] = {
    5, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ...
    52, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    56, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_14_SpriteData0[ROOM_SPRITE_DATA_COUNT(1)] = {
    4, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_15_SpriteData0[ROOM_SPRITE_DATA_COUNT(14)] = {
    3, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    3, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    4, 21, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    5, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    15, 14, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    15, 21, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
...
const u8 sSector5_16_SpriteData0[ROOM_SPRITE_DATA_COUNT(1)] = {
    20, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(2),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_17_SpriteData0[ROOM_SPRITE_DATA_COUNT(13)] = {
    3, 6, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    3, 9, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(3),
    3, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    7, 16, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ...
    14, 35, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    14, 36, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(3),
    14, 39, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    14, 42, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
...
const u8 sSector5_18_SpriteData0[ROOM_SPRITE_DATA_COUNT(12)] = {
    5, 23, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    5, 25, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    13, 7, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(3),
    13, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    13, 15, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    14, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    15, 19, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    15, 26, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ...
    24, 20, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_19_SpriteData0[ROOM_SPRITE_DATA_COUNT(17)] = {
    ...
    13, 22, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    ...
    15, 6, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    15, 10, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(1),
    15, 12, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(1),
    15, 13, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    15, 15, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(1),
    15, 17, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
...
const u8 sSector5_20_SpriteData0[ROOM_SPRITE_DATA_COUNT(3)] = {
    ...
    15, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_24_SpriteData2[ROOM_SPRITE_DATA_COUNT(1)] = {
    40, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector5_24_SpriteData1[ROOM_SPRITE_DATA_COUNT(3)] = {
    ...
    30, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    ROOM_SPRITE_DATA_TERMINATOR
};
...
const u8 sSector5_36_SpriteData0[ROOM_SPRITE_DATA_COUNT(7)] = {
    6, 7, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    6, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    ...
    20, 11, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_39_SpriteData1[ROOM_SPRITE_DATA_COUNT(6)] = {
    ...
    10, 21, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
...
const u8 sSector5_41_SpriteData0[ROOM_SPRITE_DATA_COUNT(4)] = {
    ...
    10, 19, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(1),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_42_SpriteData0[ROOM_SPRITE_DATA_COUNT(8)] = {
    4, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    5, 4, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    ...
    16, 23, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
...
const u8 sSector5_43_SpriteData0[ROOM_SPRITE_DATA_COUNT(1)] = {
    8, 54, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(0),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_44_SpriteData0[ROOM_SPRITE_DATA_COUNT(7)] = {
    4, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    26, 11, ROOM_SPRITESET_IDX(PSPRITE_TARGET_DIAGONAL),
    34, 9, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(0),
    41, 8, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(0),
    48, 8, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(0),
    53, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    59, 12, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(5),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_45_SpriteData0[ROOM_SPRITE_DATA_COUNT(8)] = {
    3, 7, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
    3, 10, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(3),
...
const u8 sSector5_47_SpriteData0[ROOM_SPRITE_DATA_COUNT(10)] = {
    3, 5, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    3, 6, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(2),
    3, 8, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(2),
    3, 9, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    3, 10, SSP_X_ABSORBABLE_BY_SAMUS | ROOM_SPRITESET_IDX(2),
    4, 13, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
...
const u8 sSector5_48_SpriteData0[ROOM_SPRITE_DATA_COUNT(1)] = {
    10, 8, SSP_CAN_ABSORB_ADDITIONAL_X | ROOM_SPRITESET_IDX(4),
    ROOM_SPRITE_DATA_TERMINATOR
};
ALIGN2();
...
const u8 sSector5_3_Bg3[] = {
    1, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector5_3_Bg3.tt.lz")
};
ALIGN2();

const u8 sSector5_7_Bg3[] = {
    1, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector5_7_Bg3.tt.lz")
};
ALIGN2();

const u8 sMainDeck_46_Bg0[] = {
    0, 0, 0, 0,
    _INCBIN_U8("data/rooms/MainDeck_46_Bg0.tt.lz")
};
ALIGN2();

const u8 sSector5_20_Bg3[] = {
    2, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector5_20_Bg3.tt.lz")
};
ALIGN2();

const u8 sSector5_20_Bg0[] = {
    0, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector5_20_Bg0.tt.lz")
};
ALIGN2();

const u8 sSector5_3_Bg0[] = {
    1, 0, 0, 0,
    _INCBIN_U8("data/rooms/Sector5_3_Bg0.tt.lz")
};
ALIGN2();
