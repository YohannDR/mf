...
static const u16 sFrameData_2f9220_Frame0[OAM_DATA_SIZE(4)] = {
    4,
...
static const u16 sFrameData_2f9248_Frame1[OAM_DATA_SIZE(4)] = {
    4,
...
static const u16 sFrameData_2f92b0_Frame1[OAM_DATA_SIZE(5)] = {
    5,
...
static const u16 sFrameData_2f9318_Frame1[OAM_DATA_SIZE(4)] = {
    4,
...
static const u16 sFrameData_2f9380_Frame1[OAM_DATA_SIZE(4)] = {
    4,
...
const struct FrameData sFrameData_2f9220[5] = {
    [0] = {
        .pFrame = sFrameData_2f9220_Frame0,
        .timer = 10
    },
    [1] = {
        .pFrame = sFrameData_2f9220_Frame1,
        .timer = 10
    },
    [2] = {
        .pFrame = sFrameData_2f9220_Frame2,
        .timer = 10
    },
    [3] = {
        .pFrame = sFrameData_2f9220_Frame3,
        .timer = 10
    },
...
const struct FrameData sFrameData_2f9248[3] = {
    ...
    [1] = {
        .pFrame = sFrameData_2f9248_Frame1,
        .timer = 16
    },
...
const struct FrameData sFrameData_2f9288[5] = {
    [0] = {
        .pFrame = sFrameData_2f9288_Frame0,
        .timer = 10
    },
    [1] = {
        .pFrame = sFrameData_2f9288_Frame1,
        .timer = 10
    },
    [2] = {
        .pFrame = sFrameData_2f9288_Frame2,
        .timer = 10
    },
    [3] = {
        .pFrame = sFrameData_2f9288_Frame3,
        .timer = 10
    },
    [4] = FRAME_DATA_TERMINATOR
};
...
const struct FrameData sFrameData_2f92b0[3] = {
    ...
    [1] = {
        .pFrame = sFrameData_2f92b0_Frame1,
        .timer = 16
    },
    [2] = FRAME_DATA_TERMINATOR
};
...
const struct FrameData sFrameData_2f92f0[5] = {
    [0] = {
        .pFrame = sFrameData_2f92f0_Frame0,
        .timer = 10
    },
    [1] = {
        .pFrame = sFrameData_2f92f0_Frame1,
        .timer = 10
    },
    [2] = {
        .pFrame = sFrameData_2f9220_Frame2,
    ...
    [3] = {
        .pFrame = sFrameData_2f92f0_Frame3,
        .timer = 10
    },
    [4] = FRAME_DATA_TERMINATOR
};
...
const struct FrameData sFrameData_2f9318[3] = {
    ...
    [1] = {
        .pFrame = sFrameData_2f9318_Frame1,
        .timer = 16
    },
    [2] = FRAME_DATA_TERMINATOR
};
...
const struct FrameData sFrameData_2f9358[5] = {
    [0] = {
        .pFrame = sFrameData_2f9358_Frame0,
        .timer = 10
    },
    [1] = {
        .pFrame = sFrameData_2f9358_Frame1,
        .timer = 10
    },
    [2] = {
        .pFrame = sFrameData_2f9288_Frame2,
    ...
    [3] = {
        .pFrame = sFrameData_2f9358_Frame3,
        .timer = 10
    },
    [4] = FRAME_DATA_TERMINATOR
};
...
const struct FrameData sFrameData_2f9380[3] = {
    ...
    [1] = {
        .pFrame = sFrameData_2f9380_Frame1,
        .timer = 16
    },
    [2] = FRAME_DATA_TERMINATOR
};
...
const struct FrameData sFrameData_2f93c0[2] = {
    [0] = {
        .pFrame = sFrameData_2f93c0_Frame0,
        .timer = 255
    },
