...
static const s16 sMultiSpriteFrame_342180[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    [BOX_PART_0] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_3479A8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-33),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-21)
    },
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A20,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-28),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-33),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(21)
    },
    [BOX_PART_3] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-28),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(19)
    },
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A50,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-34)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B48,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(34)
    },
    [BOX_PART_6] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_7] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347BD8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-12),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-31),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A80,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-22),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-14)
    },
    [BOX_PART_11] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B78,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-22),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(14)
    }
};
...
static const s16 sMultiSpriteFrame_3421c8[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    [BOX_PART_0] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_3479A8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24)
    },
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A30,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-15),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-22)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
    ...
    [BOX_PART_3] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B28,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-15),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(22)
    },
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A60,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-15),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-36)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B58,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-15),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(36)
    },
    [BOX_PART_6] = {
    ...
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-3),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
    ...
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A90,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-15),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-16)
    },
    [BOX_PART_11] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B88,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-15),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(16)
    }
};
...
static const s16 sMultiSpriteFrame_342210[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    [BOX_PART_0] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_3479A8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-25),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-22)
    },
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A40,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-25),
    ...
    [BOX_PART_3] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B38,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(20)
    },
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A70,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-34)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B68,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(34)
    },
    [BOX_PART_6] = {
    ...
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-11),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-30),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A90,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-16)
    },
    [BOX_PART_11] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B88,
...
static const s16 sMultiSpriteFrame_342258[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    [BOX_PART_0] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_3479A8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-26),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-21)
    },
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A40,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-21),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
    ...
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A70,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-21),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-33)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B68,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-21),
    ...
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-13),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-32),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A90,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-15)
    },
    [BOX_PART_11] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B88,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
...
static const s16 sMultiSpriteFrame_3422a0[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A20,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-18)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29),
    ...
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A50,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-32)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B48,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
    ...
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-34),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A80,
...
static const s16 sMultiSpriteFrame_3422e8[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_3] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(13)
    },
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A50,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-37)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B48,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-27),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(31)
    },
    [BOX_PART_6] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-33),
    ...
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-16),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-35),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A80,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-9)
    },
    [BOX_PART_11] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B78,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
...
static const s16 sMultiSpriteFrame_342330[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    [BOX_PART_0] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_3479A8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-34),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-25)
    },
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A20,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-23)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(10)
    },
    [BOX_PART_3] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B28,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(8)
    },
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A60,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-42)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B48,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(27)
    },
    [BOX_PART_6] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-34),
    ...
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-17),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-36),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A80,
...
static const s16 sMultiSpriteFrame_342378[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    [BOX_PART_0] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_3479A8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-30)
    },
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A30,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-28)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-26),
    ...
    [BOX_PART_3] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B38,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-21),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(12)
    },
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A50,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-22),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-39)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B58,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19),
...
static const s16 sMultiSpriteFrame_3423c0[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(17)
    },
    [BOX_PART_3] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B18,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-24),
    ...
    [BOX_PART_11] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B88,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(3)
    }
};
...
static const s16 sMultiSpriteFrame_342450[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A50,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-23),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-33)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B48,
...
static const s16 sMultiSpriteFrame_342528[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-14),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
...
static const s16 sMultiSpriteFrame_342570[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    [BOX_PART_0] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_3479A8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-37),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-19)
    },
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A20,
    ...
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A80,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-28),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-11)
    },
    [BOX_PART_11] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B88,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-20),
...
static const s16 sMultiSpriteFrame_342648[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-9),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D18,
...
static const s16 sMultiSpriteFrame_342768[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    [BOX_PART_0] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_3479A8,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-10),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-13)
    },
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A30,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-5),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-11)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
    ...
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A60,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-13),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-26)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B58,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-13),
...
static const s16 sMultiSpriteFrame_3427b0[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A30,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-6),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-12)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
    ...
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D28,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-34),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
...
static const s16 sMultiSpriteFrame_3427f8[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A30,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-7),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-13)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
    ...
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D38,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-39),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A90,
...
static const s16 sMultiSpriteFrame_342840[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D48,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-37),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
...
static const s16 sMultiSpriteFrame_342888[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_8] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347C98,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-2),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D48,
...
static const s16 sMultiSpriteFrame_3428d0[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_1] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A30,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-8),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-13)
    },
    [BOX_PART_2] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347AA0,
...
static const s16 sMultiSpriteFrame_342b10[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_9] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347D58,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-35),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(0)
    },
    [BOX_PART_10] = {
...
static const s16 sMultiSpriteFrame_342d08[BOX_PART_END][MULTI_SPRITE_DATA_ELEMENT_END] = {
    ...
    [BOX_PART_4] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347A70,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-18),
        [MULTI_SPRITE_DATA_ELEMENT_X_OFFSET]  = PIXEL_TO_SUB_PIXEL(-29)
    },
    [BOX_PART_5] = {
        [MULTI_SPRITE_DATA_ELEMENT_OAM_INDEX] = FRAMEDATA_347B68,
        [MULTI_SPRITE_DATA_ELEMENT_Y_OFFSET]  = PIXEL_TO_SUB_PIXEL(-18),
