...
static const u16 sFrameData_2fb328_Frame0[OAM_DATA_SIZE(7)] = {
    7,
...
static const u16 sFrameData_2fb328_Frame1[OAM_DATA_SIZE(7)] = {
    7,
...
static const u16 sFrameData_2fb328_Frame2[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb328_Frame3[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb328_Frame8[OAM_DATA_SIZE(7)] = {
    7,
...
static const u16 sFrameData_2fb328_Frame9[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb328_Frame10[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb328_Frame11[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb328_Frame24[OAM_DATA_SIZE(7)] = {
    7,
...
static const u16 sFrameData_2fb328_Frame25[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb328_Frame26[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb328_Frame27[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb300_Frame0[OAM_DATA_SIZE(7)] = {
    7,
    0xe1, OBJ_SIZE_16x16 | 0x1f6, OBJ_PALETTE_8 | 0x28b,
    OBJ_SHAPE_VERTICAL | 0xe7, 0x0, OBJ_PALETTE_8 | 0x24f,
    0xf7, 0x0, OBJ_PALETTE_8 | 0x28f,
...
static const u16 sFrameData_2fb300_Frame1[OAM_DATA_SIZE(8)] = {
    8,
...
static const u16 sFrameData_2fb300_Frame2[OAM_DATA_SIZE(7)] = {
    7,
...
static const u16 sFrameData_2fb300_Frame3[OAM_DATA_SIZE(8)] = {
    8,
    OBJ_SHAPE_HORIZONTAL | 0xe2, 0x1f6, OBJ_PALETTE_8 | 0x28b,
...
static const u16 sFrameData_2fb258_Frame10[OAM_DATA_SIZE(4)] = {
    4,
    0xf6, 0x1fd, OBJ_PALETTE_8 | 0x292,
...
static const u16 sFrameData_2fb258_Frame11[OAM_DATA_SIZE(4)] = {
    4,
...
static const u16 sFrameData_2fb258_Frame12[OAM_DATA_SIZE(4)] = {
    4,
    0xf2, 0x1fd, OBJ_PALETTE_8 | 0x292,
...
static const u16 sFrameData_2fb258_Frame13[OAM_DATA_SIZE(4)] = {
    4,
...
static const u16 sFrameData_2fb258_Frame14[OAM_DATA_SIZE(4)] = {
    4,
...
static const u16 sFrameData_2fb258_Frame15[OAM_DATA_SIZE(4)] = {
    4,
...
static const u16 sFrameData_2fb258_Frame16[OAM_DATA_SIZE(4)] = {
    4,
    0xeb, 0x1fa, OBJ_PALETTE_8 | 0x292,
...
static const u16 sFrameData_2fb258_Frame17[OAM_DATA_SIZE(3)] = {
    3,
...
static const u16 sFrameData_2fb258_Frame18[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb258_Frame19[OAM_DATA_SIZE(8)] = {
    8,
...
static const u16 sFrameData_2fb420_Frame1[OAM_DATA_SIZE(2)] = {
    2,
...
static const u16 sFrameData_2fb420_Frame2[OAM_DATA_SIZE(7)] = {
    7,
...
static const u16 sFrameData_2fb420_Frame3[OAM_DATA_SIZE(9)] = {
    9,
...
static const u16 sFrameData_2fb420_Frame4[OAM_DATA_SIZE(10)] = {
    10,
...
static const u16 sFrameData_2fb420_Frame5[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb420_Frame6[OAM_DATA_SIZE(1)] = {
    1,
    OBJ_SHAPE_HORIZONTAL | 0xf8, OBJ_SIZE_32x8 | 0x1f4, OBJ_PALETTE_8 | 0x267
};

static const u16 sFrameData_2fb4d0_Frame0[OAM_DATA_SIZE(1)] = {
    1,
    OBJ_SHAPE_HORIZONTAL | 0xf8, OBJ_SIZE_32x8 | 0x1f5, OBJ_PALETTE_8 | 0x247
};

static const u16 sFrameData_2fb5d0_Frame0[OAM_DATA_SIZE(2)] = {
    2,
    0xf8, 0x1f4, OBJ_PALETTE_8 | 0x287,
    OBJ_SHAPE_HORIZONTAL | 0xf8, 0x1fc, OBJ_PALETTE_8 | 0x243
};

static const u16 sFrameData_2fb410_Frame0[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb488_Frame4[OAM_DATA_SIZE(7)] = {
    7,
...
static const u16 sFrameData_2fb460_Frame0[OAM_DATA_SIZE(6)] = {
    6,
...
static const u16 sFrameData_2fb460_Frame1[OAM_DATA_SIZE(5)] = {
    5,
...
static const u16 sFrameData_2fb460_Frame2[OAM_DATA_SIZE(5)] = {
    5,
...
static const u16 sFrameData_2fb460_Frame3[OAM_DATA_SIZE(5)] = {
    5,
    0xec, OBJ_SIZE_16x16 | 0x1f6, OBJ_PALETTE_8 | 0x28d,
...
const struct FrameData sFrameData_2fb258[21] = {
    [0] = {
        .pFrame = sFrameData_2fb258_Frame0,
        .timer = 2
    },
    [1] = {
        .pFrame = sFrameData_2fb258_Frame1,
        .timer = 2
    },
    [2] = {
        .pFrame = sFrameData_2fb258_Frame2,
        .timer = 2
    },
    [3] = {
        .pFrame = sFrameData_2fb258_Frame3,
        .timer = 2
    },
    [4] = {
        .pFrame = sFrameData_2fb258_Frame2,
    ...
    [7] = {
        .pFrame = sFrameData_2fb258_Frame7,
        .timer = 6
    },
    [8] = {
        .pFrame = sFrameData_2fb258_Frame8,
        .timer = 6
    },
    [9] = {
        .pFrame = sFrameData_2fb258_Frame9,
        .timer = 6
    },
    [10] = {
        .pFrame = sFrameData_2fb258_Frame10,
        .timer = 7
    },
    [11] = {
        .pFrame = sFrameData_2fb258_Frame11,
        .timer = 6
    },
    [12] = {
        .pFrame = sFrameData_2fb258_Frame12,
        .timer = 7
    },
    [13] = {
        .pFrame = sFrameData_2fb258_Frame13,
        .timer = 5
    },
    [14] = {
        .pFrame = sFrameData_2fb258_Frame14,
        .timer = 5
    },
    [15] = {
        .pFrame = sFrameData_2fb258_Frame15,
        .timer = 4
    },
    [16] = {
        .pFrame = sFrameData_2fb258_Frame16,
        .timer = 4
    },
    [17] = {
        .pFrame = sFrameData_2fb258_Frame17,
        .timer = 10
    },
    [18] = {
        .pFrame = sFrameData_2fb258_Frame18,
        .timer = 8
    },
    [19] = {
        .pFrame = sFrameData_2fb258_Frame19,
        .timer = 5
    },
...
const struct FrameData sFrameData_2fb300[5] = {
    [0] = {
        .pFrame = sFrameData_2fb300_Frame0,
        .timer = 12
    },
    [1] = {
        .pFrame = sFrameData_2fb300_Frame1,
        .timer = 12
    },
    [2] = {
        .pFrame = sFrameData_2fb300_Frame2,
        .timer = 12
    },
    [3] = {
        .pFrame = sFrameData_2fb300_Frame3,
        .timer = 12
    },
...
const struct FrameData sFrameData_2fb328[29] = {
    [0] = {
        .pFrame = sFrameData_2fb328_Frame0,
        .timer = 12
    },
    [1] = {
        .pFrame = sFrameData_2fb328_Frame1,
        .timer = 8
    },
    [2] = {
        .pFrame = sFrameData_2fb328_Frame2,
        .timer = 12
    },
    [3] = {
        .pFrame = sFrameData_2fb328_Frame3,
        .timer = 6
    },
    [4] = {
        .pFrame = sFrameData_2fb328_Frame0,
    ...
    [8] = {
        .pFrame = sFrameData_2fb328_Frame8,
        .timer = 14
    },
    [9] = {
        .pFrame = sFrameData_2fb328_Frame9,
        .timer = 10
    },
    [10] = {
        .pFrame = sFrameData_2fb328_Frame10,
        .timer = 12
    },
    [11] = {
        .pFrame = sFrameData_2fb328_Frame11,
        .timer = 8
    },
    [12] = {
        .pFrame = sFrameData_2fb328_Frame0,
    ...
    [24] = {
        .pFrame = sFrameData_2fb328_Frame24,
        .timer = 12
    },
    [25] = {
        .pFrame = sFrameData_2fb328_Frame25,
        .timer = 8
    },
    [26] = {
        .pFrame = sFrameData_2fb328_Frame26,
        .timer = 16
    },
    [27] = {
        .pFrame = sFrameData_2fb328_Frame27,
        .timer = 10
    },
...
const struct FrameData sFrameData_2fb410[2] = {
    [0] = {
        .pFrame = sFrameData_2fb410_Frame0,
        .timer = 14
    },
...
const struct FrameData sFrameData_2fb420[8] = {
    ...
    [1] = {
        .pFrame = sFrameData_2fb420_Frame1,
        .timer = 8
    },
    [2] = {
        .pFrame = sFrameData_2fb420_Frame2,
        .timer = 6
    },
    [3] = {
        .pFrame = sFrameData_2fb420_Frame3,
        .timer = 6
    },
    [4] = {
        .pFrame = sFrameData_2fb420_Frame4,
        .timer = 5
    },
    [5] = {
        .pFrame = sFrameData_2fb420_Frame5,
        .timer = 4
    },
    [6] = {
        .pFrame = sFrameData_2fb420_Frame6,
        .timer = 255
    },
...
const struct FrameData sFrameData_2fb460[5] = {
    [0] = {
        .pFrame = sFrameData_2fb460_Frame0,
        .timer = 10
    },
    [1] = {
        .pFrame = sFrameData_2fb460_Frame1,
        .timer = 10
    },
    [2] = {
        .pFrame = sFrameData_2fb460_Frame2,
        .timer = 10
    },
    [3] = {
        .pFrame = sFrameData_2fb460_Frame3,
        .timer = 10
    },
    [4] = FRAME_DATA_TERMINATOR
};
...
const struct FrameData sFrameData_2fb488[7] = {
    ...
    [4] = {
        .pFrame = sFrameData_2fb488_Frame4,
        .timer = 10
    },
    [5] = {
        .pFrame = sFrameData_2fb300_Frame0,
...
const struct FrameData sFrameData_2fb4d0[11] = {
    [0] = {
        .pFrame = sFrameData_2fb4d0_Frame0,
        .timer = 8
    },
    [1] = {
        .pFrame = sFrameData_2fb420_Frame6,
...
const struct FrameData sFrameData_2fb5d0[8] = {
    [0] = {
        .pFrame = sFrameData_2fb5d0_Frame0,
        .timer = 8
    },
    [1] = {
        .pFrame = sFrameData_2fb258_Frame0,
