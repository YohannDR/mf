...
static const u16 sMessageBoxYesNoCursorOam_Frame0[] = {
    1,
    0xfc, 0x1fc, OBJ_PALETTE_8 | 0x21e
};

static const u16 sMessageBoxYesNoCursorOam_Frame1[] = {
    1,
    0xfc, 0x1fd, OBJ_PALETTE_8 | 0x21e
};

static const u16 sMessageBoxYesNoCursorOam_Frame2[] = {
    1,
    0xfc, 0x1fe, OBJ_PALETTE_8 | 0x21e
};

static const u16 sMessageBoxOam_PopUp_Frame0[] = {
    2,
    0xfc, 0x1f8, OBJ_PALETTE_8 | 0x21d,
    0xfc, OBJ_X_FLIP | 0x0, OBJ_PALETTE_8 | 0x21d
};

static const u16 sMessageBoxOam_PopUp_Frame1[] = {
    3,
...
static const u16 sMessageBoxOam_PopUp_Frame2[] = {
    5,
...
static const u16 sMessageBoxOam_PopUp_Frame3[] = {
    7,
...
static const u16 sMessageBoxOam_PopUp_Frame4[] = {
    9,
...
static const u16 sMessageBoxOam_PopUp_Frame5[] = {
    18,
...
static const u16 sMessageBoxOam_PopUp_Frame6[] = {
    9,
...
static const u16 sMessageBoxOam_PopUp_Frame7[] = {
    18,
...
static const u16 sMessageBoxOam_PopUp_Frame8[] = {
    18,
...
static const u16 sMessageBoxOam_PopUp_Frame9[] = {
    18,
...
static const u16 sMessageBoxOam_Static_Frame0[] = {
    18,
...
static const u16 sMessageBoxOam_31f72c[] = {
    0
};

const struct FrameData sMessageBoxYesNoCursorOam[5] = {
    [0] = {
        .pFrame = sMessageBoxYesNoCursorOam_Frame0,
        .timer = 8
    },
    [1] = {
        .pFrame = sMessageBoxYesNoCursorOam_Frame1,
        .timer = 4
    },
    [2] = {
        .pFrame = sMessageBoxYesNoCursorOam_Frame2,
        .timer = 8
    },
    [3] = {
        .pFrame = sMessageBoxYesNoCursorOam_Frame1,
...
const struct FrameData sMessageBoxOam_PopUp[11] = {
    [0] = {
        .pFrame = sMessageBoxOam_PopUp_Frame0,
        .timer = 1
    },
    [1] = {
        .pFrame = sMessageBoxOam_PopUp_Frame1,
        .timer = 1
    },
    [2] = {
        .pFrame = sMessageBoxOam_PopUp_Frame2,
        .timer = 1
    },
    [3] = {
        .pFrame = sMessageBoxOam_PopUp_Frame3,
        .timer = 1
    },
    [4] = {
        .pFrame = sMessageBoxOam_PopUp_Frame4,
        .timer = 1
    },
    [5] = {
        .pFrame = sMessageBoxOam_PopUp_Frame5,
        .timer = 2
    },
    [6] = {
        .pFrame = sMessageBoxOam_PopUp_Frame6,
        .timer = 2
    },
    [7] = {
        .pFrame = sMessageBoxOam_PopUp_Frame7,
        .timer = 2
    },
    [8] = {
        .pFrame = sMessageBoxOam_PopUp_Frame8,
        .timer = 3
    },
    [9] = {
        .pFrame = sMessageBoxOam_PopUp_Frame9,
        .timer = 3
    },
    [10] = FRAME_DATA_TERMINATOR
};

const struct FrameData sMessageBoxOam_Removal[11] = {
    [0] = {
        .pFrame = sMessageBoxOam_PopUp_Frame9,
        .timer = 3
    },
...
const struct FrameData sMessageBoxOam_Static[2] = {
    [0] = {
        .pFrame = sMessageBoxOam_Static_Frame0,
        .timer = 255
    },
