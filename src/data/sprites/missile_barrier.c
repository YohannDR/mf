...
static const u16 sMissileBarrierOam_31c2f8_Frame0[] = {
    4,
...
static const u16 sMissileBarrierOam_31c2f8_Frame1[] = {
    4,
...
static const u16 sMissileBarrierOam_31c2f8_Frame2[] = {
    4,
...
static const u16 sMissileBarrierOam_31c320_Frame0[] = {
    4,
    0xe0, OBJ_Y_FLIP | OBJ_SIZE_16x16 | 0x1f8, OBJ_PALETTE_8 | 0x202,
    0xf0, OBJ_Y_FLIP | OBJ_SIZE_16x16 | 0x1f8, OBJ_PALETTE_8 | 0x200,
    0x10, OBJ_SIZE_16x16 | 0x1f8, OBJ_PALETTE_8 | 0x202,
...
static const u16 sMissileBarrierOam_31c348_Frame1[] = {
    3,
    OBJ_SHAPE_HORIZONTAL | 0xf5, OBJ_SIZE_32x16 | 0x1f5, OBJ_PALETTE_8 | 0x210,
    OBJ_SHAPE_HORIZONTAL | 0x5, OBJ_SIZE_32x8 | 0x1ed, OBJ_PALETTE_8 | 0x213,
...
static const u16 sMissileBarrierOam_31c348_Frame2[] = {
    3,
    OBJ_SHAPE_HORIZONTAL | 0xf5, OBJ_SIZE_32x16 | 0x1f5, OBJ_PALETTE_8 | 0x210,
    OBJ_SHAPE_HORIZONTAL | 0x5, OBJ_SIZE_32x8 | 0x1ed, OBJ_PALETTE_8 | 0x213,
...
static const u16 sMissileBarrierOam_31c348_Frame3[] = {
    4,
...
const struct FrameData sMissileBarrierOam_31c2f8[5] = {
    [0] = {
        .pFrame = sMissileBarrierOam_31c2f8_Frame0,
        .timer = 8
    },
    [1] = {
        .pFrame = sMissileBarrierOam_31c2f8_Frame1,
        .timer = 8
    },
    [2] = {
        .pFrame = sMissileBarrierOam_31c2f8_Frame2,
        .timer = 8
    },
    [3] = {
        .pFrame = sMissileBarrierOam_31c2f8_Frame1,
...
const struct FrameData sMissileBarrierOam_31c320[5] = {
    [0] = {
        .pFrame = sMissileBarrierOam_31c320_Frame0,
        .timer = 4
    },
    [1] = {
        .pFrame = sMissileBarrierOam_31c320_Frame1,
        .timer = 3
    },
    [2] = {
        .pFrame = sMissileBarrierOam_31c320_Frame2,
        .timer = 2
    },
    [3] = {
        .pFrame = sMissileBarrierOam_31c320_Frame3,
        .timer = 1
    },
    [4] = FRAME_DATA_TERMINATOR
};

const struct FrameData sMissileBarrierOam_31c348[5] = {
    [0] = {
        .pFrame = sMissileBarrierOam_31c348_Frame0,
        .timer = 8
    },
    [1] = {
        .pFrame = sMissileBarrierOam_31c348_Frame1,
        .timer = 8
    },
    [2] = {
        .pFrame = sMissileBarrierOam_31c348_Frame2,
        .timer = 8
    },
    [3] = {
        .pFrame = sMissileBarrierOam_31c348_Frame3,
        .timer = 8
    },
    [4] = FRAME_DATA_TERMINATOR
};
