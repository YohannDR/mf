...
/**
 * @brief 6258c | 34 | Starts a vertical screen shake
 * 
...
/**
 * @brief 625c0 | 34 | Starts an horizontal screen shake
 * 
 * @param duration Duration
 * @param param_2 To document
 * @return u8 Screen shake timer
...
/**
 * @brief 625f4 | 30 | Starts an horizontal screen shake, unused
 * 
 * @param duration Duration
 * @return u8 Screen shake timer
 */
...
/**
 * @brief 62624 | 68 | Updates the vertical screen shake
 * 
...
/**
 * @brief 6268c | 68 | Updates the horizontal screen shake
 * 
 * @return s32 Screen offset
 */
